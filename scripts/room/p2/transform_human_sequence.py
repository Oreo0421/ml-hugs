...
run command
 ...
 python scripts/transform_human_sequence.py   --input_dir "transformed_humans/ply"   --output_dir
...
def main():
    ...
    transform_matrix_scene  = np.array([ [ 0.021576968953, 0.033191353083, -0.357816666365, 12.875786781311], [-0.189275264740, 0.305757462978, 0.016948699951,
                                        3.911694049835], [ 0.305465757847, 0.187111526728, 0.035776726902, -6.761519432068], [ 0.0, 0.0, 0.0, 1.0] ])
    T_shift = np.array([
        [ 0.999959647655,  0.008944939822,  0.000847941323, -0.332618743181],
        [-0.008936725557,  0.999917387962, -0.009240317158,  0.855987310410],
        [-0.000930525362,  0.009232366458,  0.999956965446, -1.782292842865],
        [ 0.0,             0.0,             0.0,             1.0]])

    # Apply both transforms in sequence
    transform_matrix = T_shift @ transform_matrix_scene @ transform
